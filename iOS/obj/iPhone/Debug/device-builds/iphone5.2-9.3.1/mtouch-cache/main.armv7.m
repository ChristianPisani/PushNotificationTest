...
extern void *mono_aot_module_PushNotificationExampleiOS_info;
...
extern void *mono_aot_module_PushNotificationExample_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_PushNotificationExampleiOS_info);
	...
	mono_aot_register_module (mono_aot_module_PushNotificationExample_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "PushNotificationExampleiOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
